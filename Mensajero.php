...
<html>
    <head>
        <meta charset="UTF-8">
        <title></title>
        <link type="text/css" href="Estilos/EstilosMensajero.css" rel="stylesheet">
    ...
    <body>
        <div id="web">
            <header>
                ...
                <a href="#" title="ver Perfil" class="a"><h3>MENSAJERO: <?php echo $_GET['user']; ?></h3></a>
                <nav class="menu2">
                    ...
                    <menu>
                        ...
                        <li><a href="ProductosAEntregar.php" id="crearDiseño" class="a" title="Registrarse">Productos a entregar</a></li>
                    </menu>
                </nav>
            </header>
            <div id="menuIzq">
                        ...
                        <div class="col-sm-4 col-lg-4 col-md-4">
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    ...
                                    <h4><a href="VerProducto.php?id='.$row['id'].'&userM='.$_GET['user'].'">'.$row['nombre'].'</a>
                                    </h4>
                                    <p><a target="_blank" href="VerProducto.php?id='.$row['id'].'&userM='.$_GET['user'].'">Ver Mas</a>.</p>
                                </div>
                                <div class="ratings">
