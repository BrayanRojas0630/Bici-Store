...
<html>
    <head>
        <meta charset="UTF-8">
        <title></title>
        <link type="text/css" href="Estilos/EstilosProveedor.css" rel="stylesheet">
            ...
            <header>
                ...
                <nav class="menu2">
                    ...
                    <menu>
                        ...
                        <li><a href="PublicarProducto.php" id="crearDiseño" class="a" title="Publicar Producto">Publicar Producto</a></li>
                    </menu>
                </nav>
            </header>
            <div id="menuIzq">
                        ...
                        <div class="col-sm-4 col-lg-4 col-md-4">
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    ...
                                    <h4><a href="VerProducto.php?id='.$row['id'].'&userP='.$_GET['user'].'">'.$row['nombre'].'</a>
                                    </h4>
                                    <p><a target="_blank" href="VerProducto.php?id='.$row['id'].'&userP='.$_GET['user'].'">Ver Mas</a>.</p>
                                </div>
                                <div class="ratings">
